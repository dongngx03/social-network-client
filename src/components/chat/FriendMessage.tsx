...
const FriendMessage = () => {
    return (
        ...
        <div className="w-full h-auto pl-5">
            <div className="w-2/3 py-2 flex justify-start items-start">
                ...
                <div className="w-full flex-1 relative px-3 group flex justify-start items-center gap-1 ">
                    <span className=" w-auto h-auto break-all bg-[#F1F1F1] py-2 px-3 rounded-lg font-sans text-[15px]">
